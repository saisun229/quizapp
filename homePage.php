											...
											<div id="myForm"  hidden="true">
												<form action="sessionPage.php" method="POST" >
													<div class="form-group" id="form3">
														...
														<label>Student ID :</label><input  class="form-control" id="studentID" type="text" name="studentID" required/></br>
														<label>First Name :</label><input  class="form-control" id="fName" type="text" name="firstName" required/></br>
														<label>Last Name :</label><input  class="form-control" id="lName" type="text" name="lastName" required/></br>
														<label>Age:</label><input  class="form-control" id="age" type="text" name="age" required/></br>
														<label>Email :</label><input  class="form-control" id="eMail" type="text" pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" name="email" required/><span>Email Format Ex:<small><b>axb33850@ucmo.edu</b></small></span></br>
